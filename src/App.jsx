...
const THEMES = [
  ...
  { id: 'calin', name: 'Câlins', icon: Heart, colorLight: 'text-rose-600', colorDark: 'text-rose-300', cardLight: 'bg-rose-50/50 border-rose-200 hover:border-rose-400 hover:shadow-rose-500/20', cardDark: 'bg-rose-950/20 border-rose-900/50 hover:border-rose-500/50 hover:shadow-rose-900/40' },
